...
<body class="min-h-screen">
    ...
    <div id="page1" class="min-h-screen bg-blue-900 p-8 text-white fade-in">
        <div class="max-w-4xl mx-auto bg-white bg-opacity-10 rounded-3xl p-8">
            <div class="text-center mb-8">
                <div class="mx-auto mb-4 text-yellow-400 text-6xl">📚</div>
            ...
            <div class="bg-white bg-opacity-20 rounded-2xl p-8">
                ...
                <div class="bg-blue-800 rounded-xl p-6 mb-6">
                    ...
                    <ul class="space-y-3">
                        <li>• Ketika dua unsur bergabung membentuk senyawa berbeda, massa unsur pertama yang bergabung dengan massa tetap unsur kedua memiliki perbandingan bilangan bulat sederhana</li>
                        <li>• Hukum ini mendukung teori atom dan menjelaskan komposisi kimia</li>
                        <li>• Menunjukkan bahwa materi terdiri dari atom-atom yang tidak dapat dibagi</li>
                    </ul>
                </div>

                <div class="bg-purple-800 rounded-xl p-6">
                    <h3 class="text-xl font-bold mb-4 text-yellow-300">Contoh Klasik:</h3>
                    <p class="mb-3">Karbon dan Oksigen membentuk CO dan CO₂:</p>
                    <ul class="space-y-2">
                        <li>• Dalam CO: 12g Karbon + 16g Oksigen</li>
                        <li>• Dalam CO₂: 12g Karbon + 32g Oksigen</li>
                        <li>• Perbandingan massa oksigen: 16:32 = 1:2 (bilangan bulat sederhana)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white bg-opacity-20 rounded-2xl p-6 text-center">
                    ...
                    <ul class="text-left space-y-2">
                        <li>• <strong class="text-red-300">CO:</strong> Pembakaran tidak sempurna (beracun)</li>
                        <li>• <strong class="text-blue-300">CO₂:</strong> Pembakaran sempurna (gas rumah kaca)</li>
                        <li>• Unsur sama (C & O) dengan perbandingan berbeda</li>
                        <li>• Penting untuk kontrol polusi udara</li>
                    </ul>
                </div>
                ...
                <div class="bg-white bg-opacity-20 rounded-2xl p-6 text-center">
                    ...
                    <ul class="text-left space-y-2">
                        <li>• <strong class="text-orange-300">Oksida Besi:</strong> FeO, Fe₂O₃, Fe₃O₄</li>
                        <li>• <strong class="text-purple-300">Oksida Belerang:</strong> SO₂, SO₃</li>
                        <li>• Sifat berbeda untuk kegunaan berbeda</li>
                        <li>• Kontrol kualitas dalam manufaktur</li>
                    </ul>
                </div>
                ...
                <div class="bg-white bg-opacity-20 rounded-2xl p-6 text-center">
                    ...
                    <ul class="text-left space-y-2">
                        <li>• Pengukuran berbagai oksida nitrogen</li>
                        <li>• Pengolahan air dengan senyawa klorin</li>
                        <li>• Memahami pembentukan polutan</li>
                        <li>• Prediksi dampak lingkungan</li>
                    </ul>
                </div>
                ...
                <div class="bg-white bg-opacity-20 rounded-2xl p-6 text-center">
                    ...
                    <ul class="text-left space-y-2">
                        <li>• Formulasi obat dengan perbandingan berbeda</li>
                        <li>• Anestesi N₂O dengan sifat khusus</li>
                        <li>• Perhitungan dosis yang tepat</li>
                        <li>• Pemahaman interaksi obat</li>
                    </ul>
                </div>
            </div>
    ...
    <div id="page3" class="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-pink-900 p-8 text-white fade-in hidden">
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-8">
                <div class="mx-auto mb-4 text-yellow-400 text-6xl">⚛️</div>
                <h1 class="text-4xl font-bold mb-4">Simulasi Pembentukan Molekul</h1>
                <p class="text-lg text-gray-300">Drag dan drop atom untuk membentuk CO dan CO₂, lalu lihat perbandingan massanya!</p>
            </div>

            <div class="grid lg:grid-cols-3 gap-6">
                <!-- Atom Inventory -->
                <div class="bg-white bg-opacity-10 rounded-2xl p-6">
                    <h3 class="text-xl font-bold mb-4 text-center">🧪 Inventori Atom</h3>
                    ...
                    <div class="mt-6 p-4 bg-blue-800 bg-opacity-50 rounded-xl">
                        ...
                        <ul class="text-sm space-y-1">
                            <li>• Drag atom ke area pembentukan</li>
                            <li>• Bentuk molekul CO dan CO₂</li>
                            <li>• Lihat perhitungan massa otomatis</li>
                            <li>• Amati perbandingan yang terbentuk</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="bg-white bg-opacity-10 rounded-2xl p-6">
                    <h3 class="text-xl font-bold mb-4 text-center">🔬 Area Pembentukan</h3>
                    ...
                    <!-- CO2 Formation -->
                    <div>
                        <h4 class="font-bold mb-3 text-center">Karbon Dioksida (CO₂)</h4>
                ...
                <div class="bg-white bg-opacity-10 rounded-2xl p-6">
                    <h3 class="text-xl font-bold mb-4 text-center">📊 Analisis & Perhitungan</h3>
                    ...
                    <div class="calculation-box">
                        <h4 class="font-bold mb-3">⚖️ Perhitungan Massa</h4>
                        <div id="massCalculations" class="space-y-2 text-sm">
                            ...
                            <div id="co2MassCalc" class="hidden">
                                <p><strong>CO₂:</strong> 12u (C) + 32u (2×O) = <span class="text-green-400">44u</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="calculation-box" id="ratioAnalysis">
                        <h4 class="font-bold mb-3">📈 Analisis Perbandingan</h4>
                    ...
                    <div id="daltonVerification" class="calculation-box hidden">
                        <h4 class="font-bold mb-3 text-green-400">✅ Verifikasi Hukum Dalton</h4>
                        <div class="text-sm space-y-2">
                            <p>Massa C tetap: 12u dalam kedua senyawa</p>
                            <p>Massa O: 16u (CO) : 32u (CO₂)</p>
                            <p class="text-yellow-400 font-bold">Perbandingan = 16:32 = 1:2 ✓</p>
        ...
        <div class="max-w-2xl mx-auto bg-white bg-opacity-10 rounded-3xl p-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white bg-opacity-20 rounded-2xl p-6">
                    ...
                    <ul class="space-y-2">
                        <li>• Jawab 15 pertanyaan kimia dengan benar untuk menang</li>
                        <li>• Jawaban salah = mengulang pertanyaan</li>
                        <li>• Lomba dengan komputer sampai 100%</li>
                        <li>• Batas waktu: 150 detik</li>
                        <li>• Skor = 100 - (waktu terpakai)</li>
                    </ul>
                </div>
            </div>
    ...
    <div id="page5" class="min-h-screen bg-teal-900 p-8 text-white fade-in hidden">
        ...
        <div class="bg-white bg-opacity-10 rounded-2xl p-4 mb-4 flex justify-between items-center">
            <div class="flex items-center">
                <span class="mr-2 text-yellow-400 text-2xl">⏰</span>
        ...
        <div class="bg-white bg-opacity-10 rounded-2xl p-6 mb-4">
            ...
            <div class="mb-4">
                <div class="flex justify-between mb-2">
                    <span>👨‍🔬 <span id="playerRaceName"></span></span>
    ...
    <div id="page6" class="min-h-screen bg-indigo-900 p-8 text-white fade-in hidden">
        <div class="max-w-4xl mx-auto bg-white bg-opacity-10 rounded-3xl p-8">
            <div class="text-center mb-6">
                <div id="resultIcon" class="mx-auto mb-4 text-6xl">🏆</div>
    ...
    <script>
        ...
        const questions = [
            {
                q: "Jika karbon dan oksigen membentuk CO dan CO₂, berapa perbandingan massa oksigen?",
                options: ["1:1", "1:2", "2:1", "1:4"],
                answer: 1
            },
            {
                q: "Pasangan senyawa yang menunjukkan hukum perbandingan berganda adalah?",
                options: ["NaCl dan KCl", "H₂O dan H₂O₂", "CH₄ dan C₂H₆", "HCl dan HBr"],
                answer: 1
            },
            {
                q: "Dalam CO, massa karbon 12g dan oksigen 16g. Dalam CO₂, massa karbon 12g dan oksigen berapa gram?",
            ...
            {
                q: "Jika nitrogen dan oksigen membentuk NO dan NO₂, perbandingan massa oksigen adalah?",
            ...
            {
                q: "Dalam senyawa H₂O dan H₂O₂, perbandingan massa oksigen adalah?",
                options: ["1:1", "1:2", "2:1", "1:4"],
                answer: 1
            },
            {
            ...
            {
                q: "CO dan CO₂ merupakan contoh dari?",
        ...
        function updateCalculations() {
            ...
            if (coComplete && co2Complete) {
                document.getElementById('ratioResults').innerHTML = `
                    ...
                    <p><strong>Massa O dalam CO₂:</strong> 32u</p>
        ...
        function checkFormComplete() {
            ...
            if (name && playerClassValue) {
                ...
                startBtn.textContent = '▶️ Mulai Balapan Kimia!';
            } else {
        ...
        function endGame(playerWon) {
            ...
            const answerKeyHtml = playerAnswers.map((answer, index) => `
                <div class="mb-2 ${answer.isCorrect ? 'text-green-300' : 'text-red-300'}">
                    ...
                    <span class="text-xs">
                        Jawaban Anda: ${answer.selected} ${answer.isCorrect ? '✓' : '✗'}<br>
